    ...
    return (
        <div className="max-w-5xl mx-auto bg-white text-zinc-800">
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-2 flex flex-col justify-center py-10 px-8 min-w-0">
                ...
                <aside className="col-span-1 border-r border-zinc-400 p-6 pt-0 min-w-0">
                        ...
                        <section>
                            ...
                            <ul className="space-y-1 text-sm">
                                {data.skills.map((skill, index) => (
                                    <li key={index} className="min-w-0">{skill}</li>
                                ))}
                            </ul>
                        </section>
                    )}
                ...
                <main className="col-span-2 p-8 pt-0 min-w-0">
